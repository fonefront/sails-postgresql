...
utils.buildSchema = function(obj) {
  ...
  Object.keys(obj).forEach(function(key) {
    ...
    var hasDefaultsTo = attr.hasOwnProperty('defaultsTo');
    ...
    var str = [
      ...
      attr.required ? ' NOT NULL' : '',            // required/not null constraint
      hasDefaultsTo && attr.defaultsTo != null ? ' DEFAULT ' + attr.defaultsTo : '' // default value
    ].join(' ').trim();
